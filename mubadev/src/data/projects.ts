...
export const PROJECTS_DATA: ProjectItem[] = [
  {
    ...
    image: '../../public/projects/eden/edenapresentation.png', // Cole o link da sua imagem
    youtubeId: 'dQw4w9WgXcQ', // ID do vídeo no YouTube (ex: youtube.com/watch?v=dQw4w9WgXcQ)
